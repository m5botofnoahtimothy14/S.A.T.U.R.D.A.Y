# AEGIS Intelligence System: Setup & Production Guide

This document outlines how to deploy and configure the **AEGIS + PMV** Unified System.
...
3.  **VeraCrypt Configuration (Production):**
    ...
    - Update `aegis/controller.py` with the path to your VeraCrypt executable.
...
Once active, the AEGIS CLI accepts the following:
