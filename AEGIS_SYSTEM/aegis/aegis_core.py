...
class AEGISCore:
    def __init__(self, passphrase: str, project_root: Path):
        ...
        # The Memory Controller is the ONLY way AEGIS interacts with the vault
    ...
    def initialize(self):
        ...
        logger.info("AEGIS Intelligence initialized and online.")
    ...
    def shutdown(self):
        ...
        if self.is_running:
            ...
            self.is_running = False
            logger.info("AEGIS Core deactivated.")
