...
$CoreDir = Join-Path $Root "saturday-core"
$BuildDir = Join-Path $CoreDir "build"
$BinDir = Join-Path $CoreDir "bin"

Write-Host ""
Write-Host "========================================" -ForegroundColor Cyan
Write-Host "  BUILDING SATURDAY VISUAL CORE (C++)" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""
...
$ExePath = Join-Path $BinDir "saturday-core.exe"
if (Test-Path $ExePath) {
    ...
    Write-Host "  .\start_saturday.ps1" -ForegroundColor Gray
    Write-Host ""
} else {
    Write-Host ""
