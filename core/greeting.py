...
class GreetingManager:
    """Manages proactive greetings and voice introductions."""
    ...
    def __init__(self, event_bus: EventBus, brain: LinkedBrain, speech: SpeechManager):
        ...
        # Intercept voice responses to handle personality blending
        self.event_bus.subscribe("voice_response", self._on_voice_response)
        
    def _on_voice_response(self, text: str):
        # Simply pass through to speech engine
        # But here we could add prefixes like "EDITH:" or "AEGIS:"
        pass

    async def greet_user(self, user_id: str):
        """Performs a contextual greeting based on the current brain hierarchy."""
