...
class CloudBridge:
    """Relays commands and status between Local AEGIS and Firebase Firestore."""
    def __init__(self, event_bus: EventBus, project_id: str, node_id: str = "aegis-primary"):
        ...
        # Subscribe to local events to push to cloud
    ...
    async def _command_listener(self):
        """Real-time listener for remote commands from Firestore."""
        if not self.db: return
