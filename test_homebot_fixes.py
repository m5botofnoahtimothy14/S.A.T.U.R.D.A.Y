#!/usr/bin/env python3
"""
Test HomeBot COM4 and MQTT fixes, and Core2 display
"""
...
def test_homebot_fixes():
    ...
    try:
        ...
        # Test connection (will fail gracefully if no broker)
        try:
            sensors.connect()
    ...
    # Test 3: Core2 Display Simulation
    print("\n[HOMEBOT TEST] 3. Testing Core2 display simulation...")
    try:
        # Simulate Core2 face drawing
        class MockDisplay:
            def __init__(self):
                self.cleared = False
                self.circles = []
